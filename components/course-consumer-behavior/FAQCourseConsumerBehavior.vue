      ...
      <div class="max-w-7xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto divide-y-2 divide-gray-200">
          <h2  class="text-3xl font-extrabold text-white sm:text-4xl text-center">
            {{ $t('courses_consumer_behavior.faq.headline') }}
          </h2>
          <dl class="mt-6 space-y-6 divide-y divide-gray-200">
            <div class="pt-6">
              <dt class="text-lg">
                ...
                <button @click="isOpenFAQ_1 = !isOpenFAQ_1"  class="text-left w-full flex justify-between items-start text-white">
                  <span class="text-xl font-medium capitalize">
                    {{ $t('courses_consumer_behavior.faq.question_1_question') }}
                  </span>
              ...
              <dd v-if="isOpenFAQ_1" class="mt-2 pr-12">
                <p class="font-normal text-lg  text-white ml-6 pt-1 leading-8" v-html="$t('courses_consumer_behavior.faq.question_1_answer')">
                </p>
              </dd>
            </div>
            ...
            <div class="pt-6">
              <dt class="text-lg">
                ...
                <button @click="isOpenFAQ_2 = !isOpenFAQ_2" class="text-left w-full flex justify-between items-start text-white">
                  <span class="text-xl font-medium capitalize">
                    {{ $t('courses_consumer_behavior.faq.question_2_question') }}
                  </span>
                  <span class="ml-6 h-7 flex items-center">
                    <!--
                      Heroicon name: chevron-down
              ...
              <dd v-if="isOpenFAQ_2" class="mt-2">
                <p class="font-normal text-lg text-white py-4">
                  {{ $t('courses_consumer_behavior.faq.question_2_answer') }}
                </p>
              </dd>
            </div>
            ...
            <div class="pt-6">
              <dt class="text-lg">
                ...
                <button @click="isOpenFAQ_3 = !isOpenFAQ_3" class="text-left w-full flex justify-between items-start text-white">
                  <span class="text-xl font-medium capitalize">
                    {{ $t('courses_consumer_behavior.faq.question_3_question') }}
                  </span>
                  <span class="ml-6 h-7 flex items-center">
                    <!--
                      Heroicon name: chevron-down
              ...
              <dd v-if="isOpenFAQ_3" class="mt-2">
                <p class="font-normal text-lg text-white py-4">
                  {{ $t('courses_consumer_behavior.faq.question_3_answer') }}
                </p>
              </dd>
            </div>
            ...
            <div class="pt-6">
              <dt class="text-lg">
                ...
                <button @click="isOpenFAQ_4 = !isOpenFAQ_4" class="text-left w-full flex justify-between items-start text-white">
                  <span class="text-xl font-medium capitalize">
                    {{ $t('courses_consumer_behavior.faq.question_4_question') }}
                  </span>
                  <span class="ml-6 h-7 flex items-center">
                    <!--
                      Heroicon name: chevron-down
              ...
              <dd v-if="isOpenFAQ_4" class="mt-2">
                <p class="font-normal text-lg text-white py-4">
                  {{ $t('courses_consumer_behavior.faq.question_4_answer') }}
                </p>
              </dd>
            </div>
            ...
            <div class="pt-6">
              <dt class="text-lg">
                ...
                <button @click="isOpenFAQ_5 = !isOpenFAQ_5" class="text-left w-full flex justify-between items-start text-white">
                  <span class="text-xl font-medium capitalize">
                    {{ $t('courses_consumer_behavior.faq.question_5_question') }}
                  </span>
                  <span class="ml-6 h-7 flex items-center">
                    <!--
                      Heroicon name: chevron-down
              ...
              <dd v-if="isOpenFAQ_5" class="mt-2 pr-12">
                <p class="font-normal text-lg text-white py-4">
                  {{ $t('courses_consumer_behavior.faq.question_5_answer') }}
                </p>
              </dd>
            </div>
          </dl>
...
<script>
export default {
  name: 'FAQCourseConsumerBehavior',
  data: () => ({
    isOpenFAQ_1: false,
    isOpenFAQ_2: false,
    isOpenFAQ_3: false,
