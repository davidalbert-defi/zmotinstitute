...
<section id="Banner-section" class="pt-24 pb-8">
  <div id="hero-section" > <!-- bg-amber-100 -->
      ...
      <div class="lg:flex-grow md:w-1/2 md:pr-8 flex flex-col md:items-start md:text-left mb-8 md:mb-0 items-center text-center">
        ...
        <p class="text-orange-shinny text-xl font-normal lg:mr-20 order-2">
          {{ $t('courses_consumer_behavior.hero.sub_headline') }}
        </p>
          <div class="mt-10 sm:flex sm:justify-center lg:justify-start order-4">
            <div class="rounded-md shadow">
              <a href="#our-courses" class="uppercase w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-bold rounded-md text-white bg-green-shinny md:py-4 md:text-lg md:px-10">
                {{ $t('courses_consumer_behavior.hero.cta_1') }}
              </a>
            </div>
...
<script>
export default {
  name: 'HeroCourseConsumerBehavior'
}
</script>
