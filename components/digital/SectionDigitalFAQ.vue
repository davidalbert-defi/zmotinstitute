      ...
      <div class="max-w-7xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto divide-y-2 divide-gray-200">
          <h2  class="text-3xl font-extrabold text-white sm:text-4xl text-center">
            {{ $t('marketing_services.faq.headline') }}
          </h2>
            ...
            <div class="pt-6">
              ...
              <dd v-if="isOpenFAQ_3" class="mt-2 pr-12">
                ...
                <p class="text-base text-indigo-200 ml-6">
                  ...
                  {{ $t('marketing_services.faq.question_3_answer_line_5') }}<br>
                  {{ $t('marketing_services.faq.question_3_answer_line_6') }}
                </p>
              </dd>
            </div>
            ...
            <div class="pt-6">
              ...
              <dd v-if="isOpenFAQ_5" class="mt-2 pr-12">
                ...
                <p class="text-base text-indigo-200 ml-6">
                  ...
                  {{ $t('marketing_services.faq.question_5_answer_line_5') }}<br>
                  {{ $t('marketing_services.faq.question_5_answer_line_6') }}<br>
                  {{ $t('marketing_services.faq.question_5_answer_line_7') }}<br>
                  {{ $t('marketing_services.faq.question_5_answer_line_8') }}<br>
                  {{ $t('marketing_services.faq.question_5_answer_line_9') }}<br>
                  {{ $t('marketing_services.faq.question_5_answer_line_10') }}
                </p>
              </dd>
            </div>
