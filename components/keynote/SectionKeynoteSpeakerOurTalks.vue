...
export default {
  name: 'SectionKeynoteSpeakerOurTalks',
  data () {
    return {
      lectures: [
        {
          title: 'keynote_1_header',
          href: '#contactform',
          category: { name: 'Article', href: '#' },
          description:
            'keynote_1_description',
          date: 'Mar 16, 2020',
          datetime: '2020-03-16',
          imageUrl: img1,
          lectureTime: '45 min'
        ...
        {
          title: 'keynote_2_header',
          href: '#contactform',
          category: { name: 'Video', href: '#' },
          description:
            'keynote_2_description',
          date: 'Mar 10, 2020',
          datetime: '2020-03-10',
          imageUrl: img2,
          lectureTime: '45 min'
        ...
        {
          title: 'keynote_3_header',
          href: '#contactform',
          category: { name: 'Case Study', href: '#' },
          description:
            'keynote_3_description',
          date: 'Feb 12, 2020',
          datetime: '2020-02-12',
          imageUrl: img3,
          lectureTime: '45 min'
