      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-10">
          ...
          L283.65,148.198z"/>
                ...
                <p class="ml-16 text-lg leading-6 font-medium text-gray-900">{{ $t('keynote_speakers.why_hire.feature_1_header') }}</p>
              </dt>
          ...
          c2.4,0,5.6-1.6,6.4-4l8.8-16.8l52,69.6H331.272z"/>
                ...
                <p class="ml-16 text-lg leading-6 font-medium text-gray-900">{{ $t('keynote_speakers.why_hire.feature_2_header') }}</p>
              </dt>
              <dd class="mt-2 ml-16 text-base text-gray-500">
            ...
            <div class="relative">
              <dt>
                ...
                <p class="ml-16 text-lg leading-6 font-medium text-gray-900">{{ $t('keynote_speakers.why_hire.feature_3_header') }}</p>
              </dt>
              <dd class="mt-2 ml-16 text-base text-gray-500">
            ...
            <div class="relative">
              <dt>
                ...
                <p class="ml-16 text-lg leading-6 font-medium text-gray-900">{{ $t('keynote_speakers.why_hire.feature_4_header') }}</p>
              </dt>
              <dd class="mt-2 ml-16 text-base text-gray-500">
